...
public class Staff {
    ...
    private List<StaffDef> genEntities() {
        ...
        list.add(new StaffDef(7001, 24235, 9001, 900));
        list.add(new StaffDef(7002, 33522, 9002, 100));
        list.add(new StaffDef(7003, 65753, 9003, 900));
        list.add(new StaffDef(7004, 22222, 9004, 900));
        list.add(new StaffDef(7005, 79678, 9005, 900));
        list.add(new StaffDef(7006, 21324, 9006, 900));
