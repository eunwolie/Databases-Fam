...
public class Librarian {
    ...
    private List<LibrarianDef> genEntities() {
        ...
        list.add(new LibrarianDef(7001,101));
        list.add(new LibrarianDef(7002,101));
        list.add(new LibrarianDef(7003,102));
        list.add(new LibrarianDef(7004,102));
        list.add(new LibrarianDef(7005,103));
